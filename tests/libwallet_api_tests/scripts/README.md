...
* Running singularity node, linked to private/public testnet. 
  ...
  [Manual](https://github.com/singularityexamples/private-testnet) explaining how to run private testnet.
...
* Directory with pre-generated wallets
  ...
  By default, tests expect these wallets to be in ```/var/singularity/testnet_pvt```. 
